	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const payload = {
				...
				linkedin,
				facilities,
				openingTime: realOpeningTime
					? realOpeningTime
					: updateList.openingTime,
				closingTime: realClosingTime
					? realClosingTime
					: updateList.closingTime,
				pricing,
			};
